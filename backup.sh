...
declare -a HOME_FILES=(".i3" ".Xresources" ".xinitrc" "ssh-add.sh" ".zshrc" ".zsh_history.backup" ".zsh_history" ".gitconfig" ".dmenurc" ".doom.d")
declare -a CONFIG_FILES=("i3status" "dunst" "compton.conf" "picom.conf" )
